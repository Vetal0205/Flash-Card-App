...
export default function FlashcardList() {
  ...
  const handleDuplicate = (card: Flashcard) => {
    fetch(`${API_BASE}/api/v1/collections/${collectionId}/flashcards/${card.flashcardID}/duplicate`, {
      method: 'POST',
      credentials: 'include',
    })
      .then((res) => res.json())
                  ...
                  <tr key={card.flashcardID} style={{ backgroundColor: i % 2 === 0 ? '#ffffff' : '#fafaf8' }}>
                    ...
                    <td style={{ ...styles.td, textAlign: 'center' }}>
                      <div style={styles.rowActions}>
                        ...
                        <button style={styles.duplicateBtn} onClick={() => handleDuplicate(card)}>Duplicate</button>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  duplicateBtn: { background: 'none', border: '1px solid #cfe3d5', borderRadius: '6px', padding: '4px 12px', fontSize: '12px', color: '#2f6e44', cursor: 'pointer', fontFamily: 'sans-serif' },
